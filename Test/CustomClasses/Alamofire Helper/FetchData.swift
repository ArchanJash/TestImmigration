...
class FetchData {
    static func BaseApiCalling(withurlString urlString: String , withjsonString parameters: Parameters,header:HTTPHeaders,withloaderMessage loaderMessage:String, withSuccess success:@escaping (_ response: (Any)) -> Void, andFailure failure:@escaping (_ error: Error?) -> Void) {
        SVProgressHUD.show()
